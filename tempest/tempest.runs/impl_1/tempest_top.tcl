...
namespace eval ::optrace {
  variable script "C:/Users/Alan/Documents/GitHub/Tempest/tempest/tempest.runs/impl_1/tempest_top.tcl"
...
OPTRACE "link_design" START { }
  link_design -top tempest_top -part xc7a100tcsg324-1
...
OPTRACE "Opt Design: write_checkpoint" START { CHECKPOINT }
  write_checkpoint -force tempest_top_opt.dcp
OPTRACE "Opt Design: write_checkpoint" END { }
OPTRACE "opt_design reports" START { REPORT }
  create_report "impl_1_opt_report_drc_0" "report_drc -file tempest_top_drc_opted.rpt -pb tempest_top_drc_opted.pb -rpx tempest_top_drc_opted.rpx"
...
OPTRACE "Place Design: write_checkpoint" START { CHECKPOINT }
  write_checkpoint -force tempest_top_placed.dcp
OPTRACE "Place Design: write_checkpoint" END { }
OPTRACE "place_design reports" START { REPORT }
  create_report "impl_1_place_report_io_0" "report_io -file tempest_top_io_placed.rpt"
  create_report "impl_1_place_report_utilization_0" "report_utilization -file tempest_top_utilization_placed.rpt -pb tempest_top_utilization_placed.pb"
  create_report "impl_1_place_report_control_sets_0" "report_control_sets -verbose -file tempest_top_control_sets_placed.rpt"
...
OPTRACE "Post-Place Phys Opt Design: write_checkpoint" START { CHECKPOINT }
  write_checkpoint -force tempest_top_physopt.dcp
...
OPTRACE "Route Design: write_checkpoint" START { CHECKPOINT }
  write_checkpoint -force tempest_top_routed.dcp
OPTRACE "Route Design: write_checkpoint" END { }
OPTRACE "route_design reports" START { REPORT }
  create_report "impl_1_route_report_drc_0" "report_drc -file tempest_top_drc_routed.rpt -pb tempest_top_drc_routed.pb -rpx tempest_top_drc_routed.rpx"
  create_report "impl_1_route_report_methodology_0" "report_methodology -file tempest_top_methodology_drc_routed.rpt -pb tempest_top_methodology_drc_routed.pb -rpx tempest_top_methodology_drc_routed.rpx"
  create_report "impl_1_route_report_power_0" "report_power -file tempest_top_power_routed.rpt -pb tempest_top_power_summary_routed.pb -rpx tempest_top_power_routed.rpx"
  create_report "impl_1_route_report_route_status_0" "report_route_status -file tempest_top_route_status.rpt -pb tempest_top_route_status.pb"
  create_report "impl_1_route_report_timing_summary_0" "report_timing_summary -max_paths 10 -file tempest_top_timing_summary_routed.rpt -pb tempest_top_timing_summary_routed.pb -rpx tempest_top_timing_summary_routed.rpx -warn_on_violation "
  create_report "impl_1_route_report_incremental_reuse_0" "report_incremental_reuse -file tempest_top_incremental_reuse_routed.rpt"
  create_report "impl_1_route_report_clock_utilization_0" "report_clock_utilization -file tempest_top_clock_utilization_routed.rpt"
  create_report "impl_1_route_report_bus_skew_0" "report_bus_skew -warn_on_violation -file tempest_top_bus_skew_routed.rpt -pb tempest_top_bus_skew_routed.pb -rpx tempest_top_bus_skew_routed.rpx"
...
if {$rc} {
  write_checkpoint -force tempest_top_routed_error.dcp
