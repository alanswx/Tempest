...
#
# Generated by export_simulation on Thu Dec 17 07:25:04 -0800 2020
#
################################################################################
...
'-reset_run' switch to the './vgRAM.sh' script.
...
./vgRAM.sh -noclean_files

For more information on the script, please type './vgRAM.sh -help'.
