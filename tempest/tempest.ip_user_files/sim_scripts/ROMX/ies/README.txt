...
#
# Generated by export_simulation on Wed Dec 16 14:23:16 -0800 2020
#
################################################################################
...
'-reset_run' switch to the './ROMX.sh' script.
...
./ROMX.sh -noclean_files

For more information on the script, please type './ROMX.sh -help'.
