...
#
# Generated by export_simulation on Wed Dec 16 14:41:58 -0800 2020
#
################################################################################
...
'-reset_run' switch to the './vgROM.sh' script.
...
./vgROM.sh -noclean_files

For more information on the script, please type './vgROM.sh -help'.
